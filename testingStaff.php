		 	...
		 	<div class="modal-dialog" role="document">
		    	<div class="modal-content">
		      		<div class="modal-header">
		        		<h3 class="modal-title" id="exampleModalLabel">Staff</h3>
		        		<button type="button" class="close" data-dismiss="modal" aria-label="Close">
		          			<span aria-hidden="true">&times;</span>
		        		</button>
		      		</div>

					<form action="insert.php" method="POST" onsubmit="return staffValidation()">
				      	<div class="modal-body">
				      		<div class="form-inline" id="staff_first">
							...
							<div class="form-inline" id="staff_second">
                                <div class="form-group required" >
							...
							<div class="form-group" id="staff_third">
                                    <div class="form-inline">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" id="birth" name="dob" placeholder="1 Jan 1990" autocomplete="off" >
                                            </div>
                                        </div>
                                    </div>
                                </div> 

							<div class="form-group" id="staff_fourth">
                                    <div class="form-inline">
                                        <div class="form-group required">
                                            <label class="ast" for="join">Joined Since (Year):</label>
                                            <small id="valJoin"></small>
                                            <div>
                                                <input type="number" class="form-control" id="join" name="joined" required>
                                            </div>
                                        </div>

                                        <div class="form-group required">
                                            <label class="ast" for="salary">Salary:</label>
                                            <small id="valSalary"></small>
                                            <div>
                                                <input type="number" class="form-control" id="salary" autocomplete="off" name="salary" placeholder="RM"required>
                                            </div>
                                        </div>
                        
                                        <div class="form-group required">
                                            <label class="ast" for="position">Position:</label>
                                            <small id="valPos"></small>
                                            <div>
							...
							<div class="form-group" id="staff_third">
                                    <div class="form-inline">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small id="valBirth"></small>
                                            <div>
                                                <input type="text" class="form-control" id="dob" name="dob" placeholder="1 Jan 1990">
                                            </div>
                                        </div>
                                    </div>
                                </div> 
							...
							<div class="form-group" id="staff_fourth">
                                    <div class="form-inline">
                                        <div class="form-group required">
                                            ...
                                            <small id="valJoin"></small>
                                            <div>
                                                <input type="number" class="form-control" id="joined" name="joined" required>
                                            </div>
                                        </div>
